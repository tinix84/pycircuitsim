...
from pycircuitsim_core.models import SimulationRequest, SimulationResult, TaskPriority


class SimulationOrchestratorBase(ABC):
    """Abstract simulation orchestrator interface.

    Provides priority-based queuing, caching, batch execution,
    retry logic, and event callbacks.
    """
